...
| [Classification](classification.md) | Three-axis request classification — domain / complexity / privacy. 89.2% confidential recall today; targets 95-97% over time via self-improvement design + parallel research programme (target conditional on adoption volume). Technical spec + research validation. | ✅ Live |
