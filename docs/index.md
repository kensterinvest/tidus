...
| [Classification](classification.md) | Three-axis request classification — domain / complexity / privacy. 89.2% confidential recall, self-improving to 95-97%. Technical spec + research validation. | ✅ Live |
